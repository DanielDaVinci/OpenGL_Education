...
namespace metareflect
{
    namespace detail
    {
        ...
        template <class T>
        inline Class const* GetClassImpl(ClassTag<std::vector<T>>) noexcept
        {
        ...
        template <class T>
        inline Type const* GetTypeImpl(TypeTag<std::vector<T>>) noexcept
        {
        ...
        inline Class const* GetClassImpl(ClassTag<std::string>) noexcept
        {
